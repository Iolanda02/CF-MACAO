    ...
    useEffect(() => {
        if (isAuthenticated && authUser) {
            const userAddress = {
                ...
                address: cart?.shippingAddress? cart.shippingAddress.address || '' : authUser.address?.address || '',
                postalCode: cart?.shippingAddress? cart.shippingAddress.postalCode || '' : authUser.address?.postalCode || '',
                city: cart?.shippingAddress? cart.shippingAddress.city || '' : authUser.address?.city || '',
                country: cart?.shippingAddress? cart.shippingAddress.country || '' : authUser.address?.country || '',
